...
export default function FormMeasureMen({idClient}) {
    ...
    const empty_field = () =>{
        ...
        setValue('biceps_circumference','')
        setValue('chest_measurement','')
        setValue('waist_measurement','')
    }
    ...
    const onSubmit = async (data) => {
        ...
        console.log('Data measure men',{...data, client_id: idClient})

        axios.post('http://localhost:8181/api/tailor_management/measure_men' , {...data, client_id: idClient} , options)
    ...
    return (
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-row justify-center my-6">
                    ...
                    <div className="flex flex-wrap gap-x-5">
                        ...
                        <div className="flex-1">
                            ...
                            <div>
                                ...
                                <div>
                                    <Input type='number' step={'0.01'} {...register('biceps_circumference' , {required:{value:true, message:'Biceps Circumference cant be null or empty'} , min:{value:0, message:'Value Biceps Circumference cant be less than 0 cm.'}})} size={'lg'} placeholder="" />
                                </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <Input type='number' step={'0.01'} {...register('waist_measurement' , {required:{value:true, message:'Waist Measurement cant be null or empty'} , min:{value:0, message:'Value Waist Measurement cant be less than 0 cm.'}})} size={'lg'} placeholder="" />
                                </div>
